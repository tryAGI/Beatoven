...
The Beatoven SDK provides integration with [Microsoft.Extensions.AI](https://learn.microsoft.com/en-us/dotnet/ai/microsoft-extensions-ai), enabling seamless interoperability with the unified .NET AI abstractions.

## Installation

```bash
dotnet add package Beatoven
```
...
using var client = new BeatovenClient(
    apiKey: Environment.GetEnvironmentVariable("BEATOVEN_API_KEY")!);
