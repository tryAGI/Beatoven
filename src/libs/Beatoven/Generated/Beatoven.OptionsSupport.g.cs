...
namespace Beatoven
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Beatoven.AutoSDKRetryOptions Retry { get; set; } = new global::Beatoven.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Beatoven.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Beatoven.IAutoSDKHook>();
        ...
        public global::Beatoven.AutoSDKClientOptions AddHook(
            global::Beatoven.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Beatoven.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Beatoven.AutoSDKClientOptions UseAuthorizationProvider(
            global::Beatoven.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Beatoven.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Beatoven.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Beatoven.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Beatoven.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Beatoven.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Beatoven.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Beatoven.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Beatoven.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Beatoven.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Beatoven.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Beatoven.AutoSDKRetryOptions? Retry { get; set; }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Beatoven.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Beatoven.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Beatoven.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Beatoven.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Beatoven.AutoSDKClientOptions clientOptions,
            global::Beatoven.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Beatoven.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Beatoven.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Beatoven.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Beatoven.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Beatoven.IAutoSDKHook, global::Beatoven.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Beatoven.AutoSDKHookContext context)
        {
