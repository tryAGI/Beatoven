...
internal static class CliRuntime
{
    ...
    public static async Task<global::Beatoven.BeatovenClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
    ...
    private static async Task WriteApiExceptionAsync(global::Beatoven.ApiException exception)
    {
        var builder = new StringBuilder();
