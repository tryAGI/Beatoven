...
namespace Beatoven.CLI;

internal static class CliRuntime
{
    private const string UserSecretsId = "Beatoven.CLI";
    private const string UserSecretApiKeyName = "BEATOVEN_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"BEATOVEN_API_KEY"];
    private const string CredentialFileDirectoryName = ".beatoven";

    public static async global::System.Threading.Tasks.Task<global::Beatoven.BeatovenClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::Beatoven.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::Beatoven.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "Http",
        ...
        return new global::Beatoven.BeatovenClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::Beatoven.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::Beatoven.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::Beatoven.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::Beatoven.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("BEATOVEN_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::Beatoven.ApiException exception)
    {
        var builder = new StringBuilder();
